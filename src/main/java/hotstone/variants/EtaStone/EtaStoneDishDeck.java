...
public class EtaStoneDishDeck implements DeckStrategy {
    @Override
    ...
    private void deckBuilder(ArrayList deckName, Player owner) {
        deckName.add(new CardImpl(GameConstants.BROWN_RICE_CARD, 1, 1, 1, false, owner,
                "Opp H: (0,-1)"));
        ...
        deckName.add(new CardImpl(GameConstants.TOMATO_SALAD_CARD, 2, 2, 2, false, owner,
                "M: (+1,0)"));
        deckName.add(new CardImpl(GameConstants.POKE_BOWL_CARD, 3, 2, 3, false, owner,
                "H: (0,+2)"));
        ...
        deckName.add(new CardImpl(GameConstants.CHICKEN_CURRY_CARD, 6, 4, 4, false, owner,
                "Kill opp M"));
